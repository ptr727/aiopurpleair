...
- **Version 2026.8**:
  ...
  - **Modern packaging** - published to PyPI as `aiopurpleair-ptr727` (the import package stays `aiopurpleair`), built with hatchling and managed with uv on a src-layout. Automated NBGV versioning (no manual tags), a 100% test-coverage gate, and syrupy snapshot tests over the response models back every release.

[pypi-link]: https://pypi.org/project/aiopurpleair-ptr727/
