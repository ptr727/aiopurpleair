...
- `CODECOV_TOKEN` is the Codecov upload token the pytest matrix uses. It is optional, since the upload is best-effort, and it lives in the Actions store only.
