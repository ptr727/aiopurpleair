...
class GeoLocation:
    ...
    @classmethod
    def from_degrees(cls, latitude_degrees: float, longitude_degrees: float) -> GeoLocation:
        ...
        return cls(latitude_radians, longitude_radians, latitude_degrees, longitude_degrees)

    @classmethod
    def from_radians(cls, latitude_radians: float, longitude_radians: float) -> GeoLocation:
    ...
    def bounding_box(self, distance_km: float) -> tuple[GeoLocation, GeoLocation]:
        ...
        if MINIMUM_LATITUDE < box_maximum_latitude < MAXIMUM_LATITUDE:
            delta_longitude = math.asin(math.sin(distance_radians) / math.cos(self.latitude_radians))
